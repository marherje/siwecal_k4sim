...
INPUT_FILE="digitized.edm4hep.root" INPUT_COLLECTION="SiPadHitsDigi" \
    OUTPUT_FILE="tracks.edm4hep.root" SEED_MOMENTUM=54.0 \
...
mv "${REPO_ROOT}/gaudi_jobs/1_e54_beam_pipeline/digitized.edm4hep.root" \
   "${PROCESSED}/${LABEL}_digitized.edm4hep.root"
mv "${REPO_ROOT}/gaudi_jobs/1_e54_beam_pipeline/tracks.edm4hep.root" \
