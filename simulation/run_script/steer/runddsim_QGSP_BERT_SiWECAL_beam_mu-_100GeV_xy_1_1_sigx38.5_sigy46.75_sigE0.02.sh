...
LOCAL_OUTPUT="output_beam_mu-_100GeV_xy_1_1_sigx38.5_sigy46.75_sigE0.02.edm4hep.root"
REMOTE_OUTPUT="/eos/experiment/drdcalo/siw-ecal/TB2026-06/Simulation/Generated/output_beam_mu-_100GeV_xy_1_1_sigx38.5_sigy46.75_sigE0.02.edm4hep.root"

ddsim --enableG4GPS \
      --macroFile    /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/steer/gps_QGSP_BERT_SiWECAL_beam_mu-_100GeV_xy_1_1_sigx38.5_sigy46.75_sigE0.02.mac \
      --steeringFile /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/steer/runddsim_QGSP_BERT_SiWECAL_beam_mu-_100GeV_xy_1_1_sigx38.5_sigy46.75_sigE0.02.py \
      &> /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/log/QGSP_BERT_SiWECAL_beam_mu-_100GeV_xy_1_1_sigx38.5_sigy46.75_sigE0.02.log
DDSIM_RC=$?
