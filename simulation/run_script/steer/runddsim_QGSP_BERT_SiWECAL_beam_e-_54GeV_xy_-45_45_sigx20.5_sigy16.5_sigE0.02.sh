...
EXPECTED_OUTPUT="/afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/data/output_beam_e-_54GeV_xy_-45_45_sigx20.5_sigy16.5_sigE0.02.edm4hep.root"

ddsim --enableG4GPS \
      --macroFile    /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/steer/gps_QGSP_BERT_SiWECAL_beam_e-_54GeV_xy_-45_45_sigx20.5_sigy16.5_sigE0.02.mac \
      --steeringFile /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/steer/runddsim_QGSP_BERT_SiWECAL_beam_e-_54GeV_xy_-45_45_sigx20.5_sigy16.5_sigE0.02.py \
      &> /afs/cern.ch/user/m/marquezh/public/siwecal_k4sim/simulation/run_script/log/QGSP_BERT_SiWECAL_beam_e-_54GeV_xy_-45_45_sigx20.5_sigy16.5_sigE0.02.log
DDSIM_RC=$?
